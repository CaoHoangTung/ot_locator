...
class Map extends React.Component {
  constructor(props) {
    super(props);
    Geocode.setApiKey(this.props.googleAPIKey);
    Geocode.enableDebug();
    this.state = {
      address: '',
      city: '',
  ...
  render() {
    ...
    let map;
    let googleMapURL = `https://maps.googleapis.com/maps/api/js?key=${this.props.googleAPIKey}&libraries=places,geocode`
    if (this.props.center.lat !== undefined) {
      map = <div id="mapContainer">
